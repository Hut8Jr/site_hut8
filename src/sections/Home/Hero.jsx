    ...
    <section className="relative overflow-hidden bg-cinza-fundo py-20 px-4 sm:px-6 max-w-full">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-10 items-center">
        ...
        <div className="flex-1 w-full lg:w-1/2">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <button
              ...
              className="inline-flex items-center justify-center bg-verde-hut8 px-6 py-3 rounded-lg font-bold hover:bg-[#8CC800] focus-visible:ring-2 focus-visible:ring-roxo-hut8 focus-visible:outline-none transition-colors cursor-pointer"
            >
              <span className="text-roxo-hut8">Entre para a Hut ➜</span>
            </button>

            <Link 
              to="/projetos" 
              className="inline-flex items-center justify-center border border-[#D1D5DB] px-6 py-3 rounded-lg hover:bg-gray-200 focus-visible:ring-2 focus-visible:ring-roxo-hut8 focus-visible:outline-none transition-colors cursor-pointer"
            >
              <span className="text-preto-hut8 text-[16px] leading-[24px] font-medium">Ver Portfólio</span>
            </Link>
          </div>
        </div>
        ...
        <div className="relative w-full max-w-[582px] aspect-square flex-shrink-1 overflow-hidden sm:overflow-visible">
          ...
          <img
            src={estudantesImg}
            alt="Estudantes da Hut8 em ambiente de desenvolvimento de software"
            width={582}
            height={582}
            loading="eager"
            fetchPriority="high"
