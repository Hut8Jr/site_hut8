    ...
    >
      <div className="relative z-10 flex flex-col gap-[10px] mt-auto">
        ...
        <div className="flex flex-wrap gap-2 items-center">
          {tag && (
            <span className="bg-[#D4FF37] text-[#344E00] px-3 h-[24px] inline-flex items-center justify-center rounded-full font-label font-bold uppercase tracking-[0.12em] text-[14px] sm:text-[18px]">
              {tag}
            </span>
          )}
        ...
        {/* Título */}
        <h2 className="font-heading tracking-tight text-white text-[2.2rem] font-[700] leading-tight m-0">
          {titulo}
        </h2>

        {/* Descrição */}
        <p className="text-white/80 text-[0.95rem] font-[400] max-w-[440px] mb-4 leading-[1.5]">
          {descricao}
        </p>
        ...
        <div className="flex justify-between items-end w-full">
          {metrica ? (
            <div className="bg-[#CAFF6F33] border border-[#CAFF6F4D] rounded-[16px] px-4 py-2 flex flex-col justify-center min-h-[55px]">
              <span className="text-[#CAFF6F] font-[700] text-[18px] leading-[22.5px] font-body">
                {metrica.valor}
              </span>
              <span className="text-white/60 font-[700] text-[10px] uppercase font-body">
                {metrica.label}
              </span>
            </div>
          ) : <div />}
